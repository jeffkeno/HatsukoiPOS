...
<html>
<head>
	<title>>Hatsukoi POS Sales and Inventory System</title>
...
<body>
<header style="height: 60px; background: #80ced6; color: white;" class="">
...
<a href="<?php echo base_url('logout/out') ?>"><button style="float: right; margin-top: 6px; margin-right: 20px;" class="btn btn-primary btn-lg" >Sign Out</button></a>
	<div style="padding-left: 20px; padding-top: 2px;">
		<h2><strong style="margin: 0">Hatsukoi POS Sales and Inventory System</strong></h2>
	</div>
</header>
<div class="main">
