...
<?php echo form_fieldset('<h1>Register Account</h1>'); ?>
...
<div class="form-group">
	<input type="submit" name="submit_account" class="btn btn-primary btn-sm" value="Register">
</div>
<?php echo form_close(); ?>
</div>
<div class="col-sm-8">

	<?php echo form_fieldset('<h1>Registed Accounts</h1>'); ?>
